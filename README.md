...
**MediScan AI** helps bridge this gap by using Machine Learning to analyze medical reports and provide simplified explanations of important health metrics.
...
MediScan AI is intended for educational and informational purposes only.
